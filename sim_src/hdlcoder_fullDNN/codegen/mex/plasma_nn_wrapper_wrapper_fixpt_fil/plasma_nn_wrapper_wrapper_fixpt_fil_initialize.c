 ...
 *
 * plasma_nn_wrapper_wrapper_fixpt_fil_initialize.c
 *
 * Code generation for function 'plasma_nn_wrapper_wrapper_fixpt_fil_initialize'
 *
 */
...
#include "plasma_nn_wrapper_fixpt_fil.h"
...
static void c_plasma_nn_wrapper_wrapper_fix(const emlrtStack *sp);
...
static const mxArray *numerictype(const emlrtStack *sp, const char_T *b,
                                  boolean_T c, const char_T *d, const char_T *e,
                                  const char_T *f, real_T g, const char_T *h,
                                  real_T i, const char_T *j, real_T k,
                                  const char_T *l, real_T m, const char_T *n,
                                  real_T o, emlrtMCInfo *location);
...
static void c_plasma_nn_wrapper_wrapper_fix(const emlrtStack *sp)
{
  ...
  emlrtAssignP(&d_eml_mx,
               numerictype(sp, "SignednessBool", false, "Signedness",
                           "Unsigned", "WordLength", 18.0, "FractionLength",
                           17.0, "BinaryPoint", 17.0, "Slope", 7.62939453125E-6,
                           "FixedExponent", -17.0, &emlrtMCI));
  emlrtAssignP(&c_eml_mx, b_numerictype(sp, "WordLength", 3.0, "FractionLength",
                                        0.0, "BinaryPoint", 0.0, "Slope", 1.0,
                                        "FixedExponent", 0.0, &emlrtMCI));
  emlrtAssignP(&b_eml_mx,
               b_numerictype(sp, "WordLength", 18.0, "FractionLength", 16.0,
                             "BinaryPoint", 16.0, "Slope", 1.52587890625E-5,
                             "FixedExponent", -16.0, &emlrtMCI));
  emlrtAssignP(
      &eml_mx,
                                  ...
                                  real_T o, emlrtMCInfo *location)
{
  ...
  pArrays[12] = emlrtCreateString((const char_T *)n);
  pArrays[13] = emlrtCreateDoubleScalar(o);
  return emlrtCallMATLABR2012b((emlrtCTX)sp, 1, &b_m, 14, &pArrays[0],
                               (const char_T *)"numerictype", true, location);
}

void plasma_nn_wrapper_wrapper_fixpt_fil_initialize(void)
{
  emlrtStack st = {
      NULL, /* site */
      NULL, /* tls */
  ...
  if (emlrtFirstTimeR2012b(emlrtRootTLSGlobal)) {
    c_plasma_nn_wrapper_wrapper_fix(&st);
  }
}

/* End of code generation (plasma_nn_wrapper_wrapper_fixpt_fil_initialize.c) */
