...
% USER INPUTS
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
filename = '../matlab/ExperimentalData/2022_07_22_11h40m51s/OL_data_0_inputOutputData.csv';

filedate = '2022_07_22_11h40m51s';%filename(3:22);
...
I_norm_factor = 0.75e5; % intensity normalization factor
