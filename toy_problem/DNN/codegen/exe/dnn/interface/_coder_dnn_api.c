...
/* Include Files */
#include "_coder_dnn_api.h"
#include "_coder_dnn_mex.h"
...
static real_T (*emlrt_marshallIn(const emlrtStack *sp, const mxArray *x1,
...
void dnn_api(const mxArray *prhs, const mxArray **plhs)
{
  ...
  x1 = emlrt_marshallIn(&st, emlrtAlias(prhs), "x1");
  /* Invoke the target function */
  b_y1 = dnn(*x1);
  /* Marshall function outputs */
  *plhs = emlrt_marshallOut(b_y1);
}
...
/*
 * File trailer for _coder_dnn_api.c
 *
 * [EOF]
 */
