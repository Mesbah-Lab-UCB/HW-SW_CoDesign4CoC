function prob_info = two_masses_load_problem_info(Nsim, varargin)
...
%          0, 0,-1]];
    ...
    prob_info.v_min = zeros(n,1);
    prob_info.v_max = zeros(n,1);
    prob_info.w_min = [-0.5*ones(n/2,1);zeros(n/2,1)];
    prob_info.w_max = [0.5*ones(n/2,1);zeros(n/2,1)];
