classdef NominalMPC < MPC
    % This class defines an MPC implementation for a nominal MPC where the
    % stage cost follows a particular form. This class utilizes the Opti
    % stack interface of CasADi.
    properties
        opti;
        opti_vars;
        opti_params;
    ...
    methods
        function self = get_mpc(self)
            ...
            % code.
            %
            % This code uses QPOASES for the QP solver which is distributed
            % with CasADi.
