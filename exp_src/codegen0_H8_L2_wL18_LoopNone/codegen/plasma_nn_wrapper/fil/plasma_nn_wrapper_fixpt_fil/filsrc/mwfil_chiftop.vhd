...
END COMPONENT;
  ...
  SIGNAL x1_1                             : std_logic_vector(17 DOWNTO 0); -- std18
  SIGNAL x1_1_tmp                         : std_logic_vector(17 DOWNTO 0); -- std18
  SIGNAL x1_2                             : std_logic_vector(17 DOWNTO 0); -- std18
  SIGNAL x1_2_tmp                         : std_logic_vector(17 DOWNTO 0); -- std18
  SIGNAL x1_3                             : std_logic_vector(2 DOWNTO 0); -- std3
  SIGNAL x1_3_tmp                         : std_logic_vector(2 DOWNTO 0); -- std3
  SIGNAL y1_1                             : std_logic_vector(17 DOWNTO 0); -- std18
  SIGNAL y1_1_tmp                         : std_logic_vector(17 DOWNTO 0); -- std18
  SIGNAL zero0                            : std_logic_vector(5 DOWNTO 0); -- std6
  SIGNAL y1_2                             : std_logic_vector(17 DOWNTO 0); -- std18
  SIGNAL y1_2_tmp                         : std_logic_vector(17 DOWNTO 0); -- std18
  SIGNAL zero1                            : std_logic_vector(5 DOWNTO 0); -- std6
