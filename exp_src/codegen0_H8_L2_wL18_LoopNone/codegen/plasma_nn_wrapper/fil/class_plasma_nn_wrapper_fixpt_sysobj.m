...
%#codegen
    ...
    methods
        function obj = class_plasma_nn_wrapper_fixpt_sysobj
            ...
            obj.InputBitWidths = [18,18,3];
            obj.OutputSignals = char('y1_1','y1_2');
            obj.OutputBitWidths = [18,18];
            ...
            obj.OutputFractionLengths = [16,16];
            obj.OutputDownsampling = [1,0];
            obj.OverclockingFactor = 1;
            obj.FPGAProgrammingFile = '/home/kimberlychan/Desktop/DNN_Generality/matlab/codegen0_H8_L2_wL18_LoopNone/codegen/plasma_nn_wrapper/fil/plasma_nn_wrapper_fixpt_fil/plasma_nn_wrapper_fixpt_fil.bit';                       
        end
    end
end
